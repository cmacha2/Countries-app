...
export default function Sort() {
  ...
  return (
    <>
      <Selector className="select animated zoomIn">
        <input type="radio" name="option" value="" onChange={onChange} />
        <i className="toggle icon icon-arrow-down"></i>
        <i className="toggle icon icon-arrow-up"></i>
        <span className="placeholder">Sin orden</span>
        <label className="option">
          ...
          <span className="title animated fadeIn">
            <i className="icon icon-speedometer"></i>Alfabeticamente A-Z
          </span>
        </label>
        <label className="option">
          <input
          ...
          />
          <span className="title animated fadeIn">
            <i className="icon icon-fire"></i>North America
          </span>
        </label>
        ...
        <label className="option">
          ...
          />
          <span className="title animated fadeIn">
            <i className="icon icon-handbag"></i>South America
          </span>
        </label>
        <label className="option">
          <input
          ...
          />
          <span className="title animated fadeIn">
            <i className="icon icon-badge"></i>Africa
          </span>
        </label>
        <label className="option">
          <input
          ...
          />
          <span className="title animated fadeIn">
            <i className="icon icon-badge"></i>Oceania
          </span>
        </label>
        <label className="option">
          <input
          ...
          />
          <span className="title animated fadeIn">
            <i className="icon icon-badge"></i>Antarctica
          </span>
        </label>
      </Selector>
      {/* <label  htmlFor="pet-select">Ordenamientos por continentes</label>
<select name="pets" id="pet-select" onChange={onChange} value={continent} >
